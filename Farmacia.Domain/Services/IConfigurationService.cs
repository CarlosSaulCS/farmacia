...
public interface IConfigurationService
{
    ...
    Task<string?> GetLastBackupPathAsync(CancellationToken cancellationToken = default);
    Task SetLastBackupPathAsync(string path, CancellationToken cancellationToken = default);
}
